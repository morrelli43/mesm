...
export const mockHomePageContent = {
  ...
  hero_subtitle: 'Fast, friendly, and professional repairs — from tyre punctures to complex battery issues. Book your repair in just 90 seconds.',
...
export const mockServicesPageContent = {
  ...
  service_2_content: 'Electrical issues can be frustrating — we diagnose the fault and get your scooter running again.',
  ...
  service_5_content: 'Brakes, lights, steering, and more — we\'ll make sure everything is in safe working order.',
...
export const mockMobileServicesPageContent = {
  ...
  step_2: 'Tell us your ideal time – we\'ll confirm the best slot with you',
  step_3: 'Our technician comes to your location, fully equipped',
  step_4: 'Most issues are fixed on the spot. If extra work is needed, we\'ll take your scooter to the workshop, repair it, and return it – with no extra fees',
